...
write(ilog,*) 'I WILL PERFORM FULL ADC1 DIAGONALIZATION IN THE FINAL SPACE'
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   write(ilog,*) 'Calculating ADC1 transition moments from ground state in ',tranmom2,' direction.'
   write(ilog,*) 'I AM Calculating ADC1 transition moments in', tranmom2,' direction, i.e. : < PSI0  D',tranmom2,' PSIn  > IN THE INITIAL SPACE'
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   nout = 100
   write(ilog,*) "ADC1 diagonalization result in the INITIAL space"
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   write(ilog,*) 'Calculating ADC1 transition moments from ground state in ',tranmom2,' direction.'
   write(ilog,*) 'I AM Calculating ADC1 transition moments in', tranmom2,' direction, i.e. : < PSI0  D',tranmom2,' PSIm  > IN THE FINAL SPACE'
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   nout = 100
   write(ilog,*) "ADC1 diagonalization result in the FINAL space"
   itmp=1+nBas**2*4*nOcc**2
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!    
   write(ilog,*) statenumber,'SELECTED STATE IN THE INITIAL SPACE has been obtained' 
       ...
       deallocate(coeff)
       deallocate(indx)
   write(ilog,*) 'Calculating ADC1 transition moments TO THE FINAL SPACE STATES,  from THIS ', statenumber, 'EXCITE STATE IN THE INITIAL SPACE  in ',tranmom2,' direction.'
   write(ilog,*) 'I AM Calculating ADC1 transition moments TO THE FINAL SPACE STATES, in', tranmom2,' direction, i.e. : < PSIin(INITIALSPACE)  D',tranmom2,' PSIm(FINAL SPACE)  > '
...
!!!write(ilog,*) i, enerf(i), os2cs*osc_strf(i)
   write(ilog,*) i, excit(i), os2cs*osc_strf(i)
    ...
    write(ilog,*) "ADC1 diagonalization results and trans. mom. FROM THE CHOOSEN EXCITED INITIAL SPACE STATE, in the FINAL space"
!!! call table2(ndimf,nout,enerf(1:nout),arrf(:,1:nout),tmvecf(:),osc_strf(:))
    itmp=1+nBas**2*4*nOcc**2
...
write(ilog,*) 'DAVIDSON DIAGONALIZATION IN THE INITIAL ADC1 SPACE DOES NOT MAKE NAY SENSE'
STOP
END IF
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
write(ilog,*) 'LANCZOS DIAGONALIZATION IN THE FINAL ADC1 SPACE DOES NOT MAKE ANY SENSE'
STOP
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    END IF
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

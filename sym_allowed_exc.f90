...
!!$  Allowed singles
    ...
    write(6,100) "Number of 1h-1p TOTAL configs in the ADC D  matrix", kpqd(1,0)
    write(6,103)
    write(6,*) "Singly excited TOTAL D  configurations"
    write(6,101) "Nr","SPN","HL1","PT1"       
    do i=1,kpqd(1,0)
       write(6,102) i,kpqd(2,i),kpqd(3,i),kpqd(5,i)
    end do


    write(6,100) "Number of 1h-1p INITIAL configs in the ADC matrix", kpq(1,0)
    write(6,103)
    write(6,*) "Singly excited INITIAL configurations"
    write(6,101) "Nr","SPN","HL1","PT1"       
    do i=1,kpq(1,0)
...
!      end if           
       ...
       write(6,200) "Number of 2h-2p TOTAL  configs i=j,a=b ", kpqd(2,0)
       write(6,203)
       write(6,*) "Doubly excited TOTAL  configs i=j,a=b"
       write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
       do i=kpqd(1,0)+1,bookmarkd
          write(6,202) i,kpqd(2,i),kpqd(3,i),kpqd(4,i),kpqd(5,i),kpqd(6,i)
       enddo
!    end if
    ...
    write(6,200) "Number of 2h-2p TOTAL configs i=j,a=b", kpqd(2,0)
       ...
       write(6,200) "Number of 2h-2p INITIAL configs i=j,a=b ", kpq(2,0)
       write(6,203)
       write(6,*) "Doubly excited INITIAL configs i=j,a=b"
       write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
...
!!$Class 3, doubles i=j,a|=b 
    ...
    write(6,200) "Number of 2h-2p TOTAL configs i=j,a|=b ", kpqd(3,0)
    write(6,203)
    write(6,*) "Doubly excited TOTAL configs i=j,a|=b "
    write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
    ...
    write(6,200) "Number of 2h-2p INITIAL configs i=j,a|=b ", kpq(3,0)
    write(6,203)
    write(6,*) "Doubly excited INITIAL configs i=j,a|=b "
    write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
...
!!$Class 4, doubles i|=j,a=b
    ...
    write(6,200) "Number of 2h-2p TOTAL configs i|=j,a=b ", kpqd(4,0)
    write(6,203)
    write(6,*) "Doubly excited TOTAL configs i|=j,a=b "
    write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
    ...
    write(6,200) "Number of 2h-2p INITIAL configs i|=j,a=b ", kpq(4,0)
    write(6,203)
    write(6,*) "Doubly excited INITIAL configs i|=j,a=b "
    write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
...
!!!!!!!!!!!!!! TOTAL CONFIG D MATRIX !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    write(6,200) "Number of 2h-2p INITIAL configs i|=j,a|=b. Spin1 ", kpqd(5,0)
    write(6,203)
    write(6,*) "Doubly excited INITIAL configs i|=j,a|=b "
    write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
    ...
    write(6,200) "Number of 2h-2p INITIAL configs i|=j,a|=b. Spin2 ", kpqd(5,0)
    write(6,203)
    write(6,*) "Doubly excited INITIAL configs i|=j,a|=b "
    write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
    ...
    write(6,200) "Number of 1h-1p INITIAL configs", kpqd(1,0)
    write(6,200) "Number of 2h-2p INITIAL configs", kpqd(2,0)+kpqd(3,0)+kpqd(4,0)+2*kpqd(5,0)
    write(6,203)
...
!!!!!!!!!!!!!! INITIAL CONFIG H MATRIX !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    write(6,200) "Number of 2h-2p INITIAL configs i|=j,a|=b. Spin1 ", kpq(5,0)
    write(6,203)
    write(6,*) "Doubly excited INITIAL configs i|=j,a|=b "
    write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
    ...
    write(6,200) "Number of 2h-2p INITIAL configs i|=j,a|=b. Spin2 ", kpq(5,0)
    write(6,203)
    write(6,*) "Doubly excited INITIAL configs i|=j,a|=b "
    write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
    ...
    write(6,200) "Number of 1h-1p INITIAL configs", kpq(1,0)
    write(6,200) "Number of 2h-2p INITIAL configs", kpq(2,0)+kpq(3,0)+kpq(4,0)+2*kpq(5,0)
    write(6,203)
...
!!!!!!!!!!!!!!!!!!!!!!!!! from excited state !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  if (statenumber.gt.0) then
    ...
    write(6,100) "Number of 1h-1p configs in the ADC matrix for final states", kpqf(1,0)
    write(6,103)
    write(6,*) "Singly excited  FINAL  configurations"
    write(6,101) "Nr","SPN","HL1","PT1"       
    do i=1,kpqf(1,0)
       write(6,102) i,kpqf(2,i),kpqf(3,i),kpqf(5,i)
    end do
...
!!!!!!!!!!!!!!!!!!  IT IS ALWAYS GOOD (POSSIBLE FINAL STATE BY SYMMETRY) !!!!!!!!!!!!!!!!!
       ...
       write(6,200) "Number of 2h-2p FINAL configs i=j,a=b ", kpqf(2,0)
       write(6,203)
       write(6,*) "Doubly excited FINAL configs i=j,a=b"
       write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
       do i=kpqf(1,0)+1,bookmarkf
          write(6,202) i,kpqf(2,i),kpqf(3,i),kpqf(4,i),kpqf(5,i),kpqf(6,i)
       enddo
!    end if
...
!!$Class 3, doubles i=j,a|=b 
    ...
    write(6,200) "Number of 2h-2p FINAL configs i=j,a|=b ", kpqf(3,0)
    write(6,203)
    write(6,*) "Doubly excited FINAL configs i=j,a|=b "
    write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
...
!!$Class 4, doubles i|=j,a=b
    ...
    write(6,200) "Number of 2h-2p FINAL configs i|=j,a=b ", kpqf(4,0)
    write(6,203)
    write(6,*) "Doubly excited FINAL configs i|=j,a=b "
    write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
...
!!$Class 5a, doubles i|=j,a|=b spin case I
    ...
    write(6,200) "Number of 2h-2p FINAL configs i|=j,a|=b. Spin1 ", kpqf(5,0)
    write(6,203)
    write(6,*) "Doubly excited FINAL configs i|=j,a|=b "
    write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
    ...
    write(6,200) "Number of 2h-2p FINAL configs i|=j,a|=b. Spin2 ", kpqf(5,0)
    write(6,203)
    write(6,*) "Doubly excited FINAL configs i|=j,a|=b "
    write(6,201) "Nr","SPN","HL1","HL2","PT1","PT2"
    ...
    write(6,200) "Number of 1h-1p FINAL configs", kpqf(1,0)
    write(6,200) "Number of 2h-2p FINAL configs", kpqf(2,0)+kpqf(3,0)+kpqf(4,0)+2*kpqf(5,0)
    write(6,203)
...
200 FORMAT(/,3("*"),A50,3x,I4)
    ...
    write(6,100) "Number of 1h-1p TOTAL configs in the ADC matrix", kpqd(1,0)
    write(6,103)
    write(6,*) "Singly excited TOTAL configurations"
    write(6,101) "Nr","SPN","HL1","PT1"       
    do i=1,kpqd(1,0)
       write(6,102) i,kpqd(2,i),kpqd(3,i),kpqd(5,i)
    end do
    ...
    write(6,200) "Number of 1h-1p TOTAL configs", kpqd(1,0)
    write(6,103)  
   ...
   if (statenumber.gt.0) then
    ...
    write(6,100) "Number of 1h-1p FINAL configs in the ADC matrix", kpqf(1,0)
    write(6,103)
    write(6,*) "Singly excited FINAL configurations"
    write(6,101) "Nr","SPN","HL1","PT1"       
    do i=1,kpqf(1,0)

...
!  Main module (module MPMODULE).
!  Version date:  30 Apr 2015
...
!    by the user in module MPMODF.  mpwds is the equivalent in 48-bit words
!    and is calculated in MPMODF from mpipl according to the formula:

!######################################################################
! Routines for wavepacket RELAXATION using John Burkardt's RKF45
! libraries. These routines are written for REAL*8 variables, and so
! cannot be used for general wavepacket propagations, in which the
...
!*****************************************************************************80
  ...
  subroutine r8_fehl ( f, neqn, noffd, y, t, h, yp, f1, f2, f3, f4, f5, s )
...
!*****************************************************************************80
  ...
  subroutine r8_rkf45 ( f, neqn, noffd, y, yp, t, tout, relerr, abserr, flag )
    ...
    integer ( kind = 4 ), parameter :: maxnfe = 30000
...
!
          call r8_fehl ( f, neqn, noffd, y, t, h, yp, f1, f2, f3, f4, f5, f1 )
          nfe = nfe + 5
!

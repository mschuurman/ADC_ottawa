...
!  MPFUN2015: Basic function module (module MPFUNB)
!  Q version: This includes conversion routines to support the real*16 datatype.
!  Version date:  17 May 2015
...
if (t2 == abs (b)) then
  ...
  write (mpldb, 2) b
2 format ('*** MPDIVD40: DP input has more than 40 significant bits:', &
  1p,d25.15)
  call mpabrt (81)
endif
...
if (t2 == abs (a)) then
  ...
  write (mpldb, 2) a
2 format ('*** MPDMC40: DP input has more than 40 significant bits:', &
  1p,d25.15)
  call mpabrt (82)
endif
...
if (t2 == abs (b)) then
  ...
  write (mpldb, 2) b
2 format ('*** MPMULD40: DP input has more than 40 significant bits:', &
  1p,d25.15)
  call mpabrt (83)
endif
...
!***   The next two routines handle conversions to/from the real*16 datatype.

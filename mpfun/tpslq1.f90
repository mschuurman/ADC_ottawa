...
!   Perform relation search.
  ...
  tm0 = second ()
  call pslq1 (idb, n, rb, eps, x, iq, r)
  tm1 = second ()
...
subroutine pslq1 (idb, n, rb, eps, x, iq, r)
...
tm0 = second ()
call itermp (idb, it, n, ix, dx, eps, b, h, y, izm)
tm1 = second ()
...
subroutine itermp (idb, it, n, ix, dx, eps, b, h, y, izm)

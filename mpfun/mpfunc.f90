...
!  MPFUN-2015: Binary-decimal and I/O subroutine module (module MPFUNC).
...
!       module or in module MPFUNA or MPFUNB.
...
implicit none
integer i, ia, ix, ixp, i1, i2, j, k, mpnw, mpnw1, na, nb, nb2, nd, ndd, &
  nexp, nl, n2
character*1 b(nb), b2(nb+10)
character*16 ca
...
nb2 = nb + 10
ndd = nd + 10
call mpeformat (a, nb2, ndd, b2, mpnw+1)

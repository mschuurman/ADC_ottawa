...
!  Version Q2: Precision level specifications are *required*; includes real*16 support.
...
!  In version #2, the next three module precedure lines are commented:
...
!   In version #2, the argument iprec is required.

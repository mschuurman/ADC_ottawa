...
!####################################################################### 
     ...
     function tau_D2_2_1(a,b1) result(func)

       implicit none

       integer, intent(in) :: a,b1
       integer             :: b,c,i,j,sym,nsym1,nsym2,nsym3,c1,i1,j1,cnt
       real*8              :: DA,eacij,ebcij,term,func
...
!####################################################################### 
     ...
     function tau_D2_2_2(apr,b1) result(func)
    
       implicit none

       integer, intent(in) :: apr,b1
       integer             :: b,c,i,j,sym,nsym1,nsym2,nsym3,c1,i1,j1,cnt
       real*8              :: DA,eacij,ebcij,term,func
...
!####################################################################### 
     ...
     function tau_D2_4_1(j1,k) result(func)

       implicit none

       integer, intent(in) :: k,j1
       integer             :: b,c,i,j,sym,nsym1,nsym2,nsym3,b1,c1,i1,cnt
       real*8              :: DA,eacij,ebcij,term,func
...
!####################################################################### 
     ...
     function tau_D2_4_2(j1,kpr) result(func)

       implicit none

       integer, intent(in) :: kpr,j1
       integer             :: b,c,i,j,sym,nsym1,nsym2,nsym3,b1,c1,i1,cnt
       real*8              :: DA,eacij,ebcij,term,func

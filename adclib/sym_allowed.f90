...
203 FORMAT(/,60("-"))
    ...
    bookmark=0
          ...
          write(ilog,*) 'MT 1 50', MT(orbsym(1),orbsym(50))    
          write(ilog,*) 'MT 1 51', MT(orbsym(1),orbsym(51))
          write(ilog,*) 'MT 1 64', MT(orbsym(1),orbsym(64)) 
...
!          write(ilog,*) 'MT 1 64', MT(orbsym(1),orbsym(64))    
    ...
    write(ilog,100) "Number of 1h-1p configs in the ADC matrix", kpq(1,0)
    write(ilog,103)
    write(ilog,*) "Singly excited configurations"
...
!!$Class 2, doubles i=j,a=b
    ...
    if (nirrep .eq. 1) then
       ...
       write(ilog,200) "Number of 2h-2p configs i=j,a=b ", kpq(2,0)
       write(ilog,203)
       write(ilog,*) "Doubly excited configs i=j,a=b"
...
!!$Class 3, doubles i=j,a|=b 
    ...
    write(ilog,200) "Number of 2h-2p configs i=j,a|=b ", kpq(3,0)
    write(ilog,203)
    write(ilog,*) "Doubly excited configs i=j,a|=b "
    write(ilog,201) "Nr","SPN","HL1","HL2","PT1","PT2"
...
!!$Class 4, doubles i|=j,a=b
    ...
    write(ilog,200) "Number of 2h-2p configs i|=j,a=b ", kpq(4,0)
    write(ilog,203)
    write(ilog,*) "Doubly excited configs i|=j,a=b "
    write(ilog,201) "Nr","SPN","HL1","HL2","PT1","PT2"
...
!!$Class 5a, doubles i|=j,a|=b spin case I
    ...
    write(ilog,200) "Number of 2h-2p configs i|=j,a|=b. Spin1 ", kpq(5,0)
    write(ilog,203)
    write(ilog,*) "Doubly excited configs i|=j,a|=b "
    write(ilog,201) "Nr","SPN","HL1","HL2","PT1","PT2"
    ...
    write(ilog,200) "Number of 2h-2p configs i|=j,a|=b. Spin2 ", kpq(5,0)
    write(ilog,203)
    write(ilog,*) "Doubly excited configs i|=j,a|=b "
    write(ilog,201) "Nr","SPN","HL1","HL2","PT1","PT2"
    ...
    write(ilog,200) "Number of 1h-1p configs", kpq(1,0)
    write(ilog,200) "Number of 2h-2p configs", kpq(2,0)+kpq(3,0)+kpq(4,0)+2*kpq(5,0)
    write(ilog,203)
